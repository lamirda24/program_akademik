...
<?php
    ...
    if(isset($_POST['simpan']))
    {
        ...
        mysqli_query($connection, "insert into kriteria values('$kode_kriteria','$nama_kriteria','$bobot_kriteria','$atribut_kriteria')");
...
<div class="col-sm-1">
  ...
  <div class="jumbotron jumbotron-fluid">
    <div class="container">
        <h1 class="display-4">Input Kriteria</h1>
    </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="inputkode" id="kode_kriteria" placeholder="Input Kode Kriteria " maxlength="6" required="">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="inputnama" id="nama_kriteria" placeholder="Input Nama Kriteria">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="inputbobot" id="bobot_kriteria" placeholder="Input Bobot Kriteria ">
    </div>
  </div>
...
<tbody>
    ...
    { ?>
        ...
        <td>
        <a href="kriteriaedit.php?ubah=<?php echo $row["kode_kriteria"]?>"
        ...
        <td>
        <a href="kriteriahapus.php?hapus=<?php echo $row["kode_kriteria"]?>"
