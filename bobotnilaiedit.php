...
<?php
    ...
    if(isset($_POST['simpan']))
    {
        ...
        mysqli_query($connection, "update bobotnilai set bobot='$bobot', nilai='$nilai'
        WHERE kode_bobotnilai = '$kode_bobotnilai'");
        header("location:bobotnilaiinput.php");
    }
    //untuk menampilkan data pada form edit
    $kode_bobotnilai = $_GET ["ubah"];
    $albertedit = mysqli_query($connection, "SELECT * FROM bobotnilai
    WHERE kode_bobotnilai = '$kode_bobotnilai'");
...
<div class="col-sm-1">
  ...
  <div class="jumbotron jumbotron-fluid">
    <div class="container">
        <h1 class="display-4">Edit Bobot Nilai</h1>
    </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="inputkode" id="kode_bobotnilai" readonly value ="<?php echo $rowedit["kode_bobotnilai"]?>" maxlength="6" required="">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="inputbobot" id="bobot" value ="<?php echo $rowedit["bobot"]?>">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="inputnilai" id="nilai" value ="<?php echo $rowedit["nilai"]?>">
    </div>
  </div>
