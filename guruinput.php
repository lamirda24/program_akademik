      ...
      <div class="row">
        ...
        <div class="col-sm-10">
          ...
          <div class="jumbotron jumbotron-fluid">
            <div class="container">
              <h1 class="display-4">Input Data Guru </h1>
            </div>
          </div>
          <!--penutup jumbotron-->
          ...
          <form method="POST">
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="inputkode" id="kode_guru" placeholder="Input Kode Guru " maxlength="6" required="">
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="inputnama" id="nama_guru" placeholder="Input Nama Guru ">
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="inputnotelp" id="notelp_guru" placeholder="Input Nomor Telepon ">
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="inputalamat" id="alamat_guru" placeholder="Input Alamat Guru ">
              </div>
            </div>
            <div class="form-group row">
        ...
        where nama_guru like '%" . $search . "%'");
          ...
          while ($row = mysqli_fetch_array($query)) { ?>
            <tr>
              ...
              <td>
                <a href="guruedit.php?ubah=<?php echo $row["kode_guru"] ?>" class="btn btn-success btn-sm" title="Edit">
              ...
              <td>
                <a href="guruhapus.php?hapus=<?php echo $row["kode_guru"] ?>" class="btn btn-danger btn-sm" title="Delete">
