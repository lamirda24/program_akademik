...
?> <h1>Anda Harus Mengisi Data</h1> <?php
                                            ...
                                            mysqli_query($connection, "insert into matapelajaran values('','$kode_matpel','$nama_matpel')");
...
<head>
    ...
    <title>Input Daftar Mata Pelajaran</title>
            ...
            <div class="row">
                ...
                <div class="col-sm-10">
                    ...
                    <div class="jumbotron jumbotron-fluid">
                        <div class="container">
                            <h1 class="display-4">Input Data Mata Pelajaran </h1>
                        </div>
                    </div>
                    <!--penutup jumbotron-->
                    ...
                    <form method="POST">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="inputkode" id="kode_matpel" placeholder="Input Kode Mata Pelajaran " maxlength="6" required="">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="inputnama" id="nama_matpel" placeholder="Input Nama Mata Pelajaran ">
                            </div>
                        </div>
        ...
        where nama_matpel like '%" . $search . "%'");
            ...
            while ($row = mysqli_fetch_array($query)) { ?>
                <tr>
                    ...
                    <td>
                        <a href="matpeledit.php?ubah=<?php echo $row["kode_matpel"] ?>" class="btn btn-success btn-sm" title="Edit">
                    ...
                    <td>
                        <a href="matpelhapus.php?hapus=<?php echo $row["kode_matpel"] ?>" class="btn btn-danger btn-sm" title="Delete">
