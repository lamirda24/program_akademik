...
<?php
    ...
    if(isset($_POST['simpan']))
    {
        ...
        mysqli_query($connection, "update parameter set min='$min', bobot='$bobot', max='$max'
    ...
    $nama_kriteria = $_GET ["ubah"];
    $albertedit = mysqli_query($connection, "SELECT * FROM parameter
    WHERE nama_kriteria = '$nama_kriteria'");
...
<div class="col-sm-1">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
<select name="inputkriteria"class="form-control" id="nama_kriteria" readonly value ="<?php echo $rowedit["nama_kriteria"]?>">>

    <option>Kriteria</option>
    <?php while($row = mysqli_fetch_array($kriteria)) 
    { ?>
    <option <?php if($row['nama_kriteria'] == $rowedit['nama_kriteria']) echo 'selected';?> value="<?php echo $row["nama_kriteria"]?>">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="inputmin" id="min" value ="<?php echo $rowedit["min"]?>">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="inputmax" id="max" value ="<?php echo $rowedit["max"]?>">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
<select name="inputbobot"class="form-control" id="bobot" readonly value ="<?php echo $rowedit["bobot"]?>">>

    <option>Bobot</option>
    <?php while($row = mysqli_fetch_array($bobotnilai)) 
    { ?>
    <option <?php if($row['bobot'] == $rowedit['bobot']) echo 'selected';?> value="<?php echo $row["bobot"]?>">
        <?php echo $row["bobot"]?>
    </option>
    <?php } ?>
...
<tbody>
    ...
    { ?>
        ...
        <td>
        <a href="parameterhapus.php?hapus=<?php echo $row["nama_kriteria"]?>"
