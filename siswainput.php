...
<head>
    ...
    <title>Input Daftar Siswa</title>
...
<div class="col-sm-1">
  ...
  <div class="jumbotron jumbotron-fluid">
    <div class="container">
        <h1 class="display-4">Input Data Siswa  </h1>
    </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="inputkode" id="kode_siswa" placeholder="Input Kode Siswa " maxlength="6" required="">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="inputnama" id="nama_siswa" placeholder="Input Nama Siswa ">
    </div>
  </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" name="inputnotelp" id="notelp_siswa" placeholder="Input Nomor Telepon ">
    </div>
  </div>
...
<tbody>
    ...
    { ?>
        ...
        <td>
        <a href="siswaedit.php?ubah=<?php echo $row["kode_siswa"]?>"
        ...
        <td>
        <a href="siswahapus.php?hapus=<?php echo $row["kode_siswa"]?>"
