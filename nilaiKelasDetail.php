...
<head>
    ...
    <title>Mata Pelajaran Kelas</title>
    ...
    <div class="card shadow mb-4">
        ...
        <body>
            <div class="jumbotron jumbotron-fluid">
                <div class="container">
                    <h1 class="display-4">Daftar Mata Pelajaran Kelas <?php echo $kelas[1] ?> <?php echo $kelas[2]; ?> - <?php echo $kelas[3] ?> </h1>
                </div>
            </div>
            <!--penutup jumbotron-->
            ...
            <table class="table table success">
                ...
                <tbody>
                    ...
                    if (isset($_POST["kirim"])) {
                        $search = $_POST['search'];
                        $query = mysqli_query($connection, "select * from jadwal where matpel like '%" . $search . "%' and kode_kelas='$kodeKelas'");
                    } else {
                    ...
                    while ($row = mysqli_fetch_array($query)) { ?>
                        <tr>
                            ...
                            <td>
                                <a href="nilaiMapelKelas.php?kelas=<?php echo $kodeKelas ?>&mapel=<?php echo $row['kode_matpel'] ?>" class="btn btn-success btn-sm" title="view">
